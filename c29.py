...
#of a block so that we can cleanly inject a suffix to it. This works
#because the sha-1 hash is just a 160 byte number, so if you split
#it into five 32 byte numbers you can use that state to append 
